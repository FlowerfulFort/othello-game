...
$(OBJ)/GameManager.o: $(SRC)/GameManager.cc
	$(CXX) $(LIBs) $(INC) -DPRETESTING -g -c $(SRC)/GameManager.cc -o $(OBJ)/GameManager.o

$(OBJ)/graphics.o: $(SRC)/graphics.cc
	$(CXX) $(LIBs) $(INC) -c $(SRC)/graphics.cc -o $(OBJ)/graphics.o

$(OBJ)/Board.o: $(SRC)/Board.cc
	$(CXX) $(LIBs) $(INC) -DPRETESTING -g -c $(SRC)/Board.cc -o $(OBJ)/Board.o

$(OBJ)/PlayerPane.o: $(SRC)/PlayerPane.cc
	$(CXX) $(LIBs) $(INC) -DPRETESTING -g -c $(SRC)/PlayerPane.cc -o $(OBJ)/PlayerPane.o

main: $(SRC)/main.cc $(OBJs)
	$(CXX) $(LIBs) $(INC) -DPRETESTING -g -o $@ $^
